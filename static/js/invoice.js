		...
		if($('.grd'+val).length == 0){
			if($('.gooid'+val).length > 0){
				...
				$('.gooid'+val).each(function(){
					...
					$(".hidden_inputs").append('<input type="hidden" name="igrn'+add+'" id="igrn'+us+'" value="'+val+'">');
					...
					$(".hidden_inputs").append('<input type="hidden" class="iamount" name="iamt'+add+'" id="iamt'+us+'" value="'+amt+'">');
					$('.tfoot2').hide();
