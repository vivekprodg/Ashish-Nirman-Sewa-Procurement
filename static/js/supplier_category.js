...
$('#SupplierCategoryForm').on('submit', function(){
	var error = 0;
	$('#spinner1').show();
	var name = $('#name').val();
	var url = $('#url').val();
	...
	if(error==0){
		document.SupplierCategoryForm.submit();
	}else{
		$('#spinner1').hide();
	}
...
$('#SupplierCategoryEditForm').on('submit', function(){
	var error = 0;
	$('#spinner2').show();
	var name = $('#editname').val();
	var url = $('#editurl').val();
	...
	if(error==0){
		document.SupplierCategoryEditForm.submit();
	}else{
		$('#spinner2').hide();
	}
	event.preventDefault();
